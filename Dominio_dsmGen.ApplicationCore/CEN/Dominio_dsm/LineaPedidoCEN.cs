...
public int Nuevo (int p_pedido, int p_cantidad, string p_importe, int p_articulo)
{
        ...
        if (p_pedido != -1) {
                ...
                // Lista de oids num
                lineaPedidoEN.Pedido = new Dominio_dsmGen.ApplicationCore.EN.Dominio_dsm.PedidoEN ();
        ...
        if (p_articulo != -1) {
                ...
                // Lista de oids num
                lineaPedidoEN.Articulo = new Dominio_dsmGen.ApplicationCore.EN.Dominio_dsm.ArticuloEN ();
...
public void Modificar (int p_LineaPedido_OID, int p_cantidad, string p_importe)
{
        LineaPedidoEN lineaPedidoEN = null;
