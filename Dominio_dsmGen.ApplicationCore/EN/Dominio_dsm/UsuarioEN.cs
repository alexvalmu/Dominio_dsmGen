...
public UsuarioEN(string email, string nombre, Nullable<DateTime> fechaNac, System.Collections.Generic.IList<Dominio_dsmGen.ApplicationCore.EN.Dominio_dsm.PedidoEN> pedido, String pass
                 )
{
