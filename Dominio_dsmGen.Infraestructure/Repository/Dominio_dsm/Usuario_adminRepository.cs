...
public System.Collections.Generic.IList<Usuario_adminEN> ReadAllDefault (int first, int size)
{
        ...
        try
        {
                ...
                if (ex is Dominio_dsmGen.ApplicationCore.Exceptions.ModelException)
                        throw;
                else throw new Dominio_dsmGen.ApplicationCore.Exceptions.DataLayerException ("Error in Usuario_adminRepository.", ex);
        }
...
public void ModifyDefault (Usuario_adminEN usuario_admin)
{
        try
        {
                ...
                usuario_adminNH.NumSocio = usuario_admin.NumSocio;
